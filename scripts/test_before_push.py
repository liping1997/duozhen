...
if __name__ == '__main__':
    ...
    run('python train.py --model train --dataroot ./datasets/mini --name horse2zebra_pretrained --no_dropout --num_test 1 --no_dropout')
    ...
    run('python train.py --dataroot ./datasets/facades/ --direction BtoA --model pix2pix --name facades_label2photo_pretrained --num_test 1')
    ...
    run('python train.py --model train --name temp_cyclegan --dataroot ./datasets/mini --num_test 1 --model_suffix "_A" --no_dropout')
    ...
    run('python train.py --model pix2pix --name temp_pix2pix --dataroot ./datasets/mini_pix2pix --num_test 1')
    ...
    run('python train.py --model template --name temp2 --dataroot ./datasets/mini_pix2pix --num_test 1')

    # colorization train/train (optional)
    ...
    run('python train.py --model colorization --name temp_color --dataroot ./datasets/mini_colorization --num_test 1')
